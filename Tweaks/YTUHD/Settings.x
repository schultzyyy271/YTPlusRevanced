...
// YTSettingsSectionItemManager category — disabled, YTPlus handles settings UI
#if 0
...
NSBundle *YTUHDBundle() {
    ...
    dispatch_once(&onceToken, ^{
        ...
        bundle = [NSBundle bundleWithPath:tweakBundlePath ?: @"/var/jb/Library/Application Support/YTUHD.bundle"];
    });
    return bundle;
}

// YTPlus handles settings UI - hooks below are disabled
#if 0
