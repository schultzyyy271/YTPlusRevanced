...
- (void)unskipSegment:(UIButton *)sender {
    if (self.currentSponsorSegment > 0) {
        [self seekToTime:CMTimeMake(((SponsorSegment *)self.skipSegments[self.currentSponsorSegment-1]).startTime,1)];
        self.unskippedSegment = self.currentSponsorSegment-1;
    } else {
        [self seekToTime:CMTimeMake(((SponsorSegment *)self.skipSegments[self.currentSponsorSegment]).startTime,1)];
        self.unskippedSegment = self.currentSponsorSegment;
    }
